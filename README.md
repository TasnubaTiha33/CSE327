...
- **Backend**:
  - ![Flask Logo](https://flask.palletsprojects.com/en/stable/_images/flask-horizontal.png) [Flask](https://flask.palletsprojects.com/en/stable/) - Lightweight web framework for Python.
